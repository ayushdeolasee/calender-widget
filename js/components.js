(function () {
    ...
    class DateTimeModel {
        ...
        exportToFastn(withTime = true) {
            ...
            if (withTime) {
                ...
                const minutesUTC_forLocalMidnight =
                    localMidnight.getUTCMinutes();
                const secondsUTC_forLocalMidnight =
        ...
        formatToString() {
            if (!isValidDate(this._date)) {
                console.warn(
                    "Invalid date detected, using current date instead"
                );
    ...
    class DateRange extends RangeBaseComponent {
            ...
            this.shadowRoot
                ...
                .addEventListener("change", (e) => {
                    try {
                        ...
                        console.error(
                            "Error handling start date input:",
                            error
                        );
                        this.render(); // Reset to valid state
                    }
        ...
        set value(newValue) {
            if (newValue.start)
                this.startModel.setDate(new Date(newValue.start));
            ...
            this.shadowRoot
                ...
                .addEventListener("change", (e) => {
                    try {
                        ...
                        console.error(
                            "Error handling start time input:",
                            error
                        );
                        this.render(); // Reset to valid state
                    }
